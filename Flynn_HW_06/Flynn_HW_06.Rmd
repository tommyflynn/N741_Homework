...
#library(knitr)
#nitr::kable(t(ldf), col.names = c("Variable Label"), caption="Use these variables from HELP dataset for Homework 06")
h1 <- helpdata %>%
  select(age, female, pss_fr, homeless, 
         pcs, mcs, cesd)
...
reg2 <- lm(cesd ~ age, female, pss_fr, homeless, pcs, mcs, data=h1)
