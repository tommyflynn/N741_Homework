...
\begin{frontmatter}
  ...
  \title{N741 Homework 2}
    \author[Emory University School of Nursing]{Tommy Flynn}
...
\paragraph{What kind of R object is the Davis
...
The Davis dataset is of the \texttt{class(davis)} R object class.
