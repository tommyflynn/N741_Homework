...
contXgdp + geom_boxplot(fill = "hotpink", colour = "yellow", outlier.colour = "blue") +
  geom_jitter(position = position_jitter(width = 0.1, height = 0), alpha = 1/4) + 
  labs(x="Continent", y="GDP per capita", title="Boxplot of Per Capita GDP by Continent")
```
...
plot(lifeExp ~ gdpPercap, colorful_gap, subset = Continent, log = "x", pch = 21, cex = sqrt(colorful_gap$pop[Continent]/pi)/1500, bg = colorful_gap$cc[Continent])
```  
