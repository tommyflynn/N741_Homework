...
p <- sum(people$Diabetes == 2)/length(people$Diabetes)
...
plot(hclust(data.dist), labels = nci.labs, main = "Average Linkage", xlab = "", 
     sub = "", ylab = "")

# Plot the tree, default linkage is 'single'
plot(hclust(data.dist), labels = nci.labs, main = "Single Linkage", xlab = "", 
     sub = "", ylab = "")
```
